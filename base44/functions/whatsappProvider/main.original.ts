/**
 * whatsappProvider — Fase Piloto Z-API
 *
 * Responsabilidade exclusiva: validar, montar e enviar requisição para a Z-API.
...
Deno.serve(async (req) => {
  try {
    ...
    if (zapiResponse.ok) {
      // HTTP 2xx — aceito na fila da Z-API
