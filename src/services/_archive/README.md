...
| `importBackupService.js` | Importação de backup do Prime Store, nunca conectada a tela; depende do destino de `dealism-backup/` | nenhum — funcionalidade não tem equivalente ativo |
